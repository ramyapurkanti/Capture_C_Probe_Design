...
def _compile_chr_regex(genome):
    #changed the function to work for zebrafish genome
    valid_chroms = re.compile('^chr([1-9]|1[0-9]|'+twenties+')$')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type = str,
        #Ramya start
        choices = ['mm9', 'mm10', 'hg18', 'hg19', 'hg38', 'zf'],
        #Ramya end
